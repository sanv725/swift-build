...
private struct DirectLinkPlanManifest: Codable {
...
public final class LinkerTaskAction: TaskAction {
    ...
    #if SWIFT_BUILD_ACCELERATOR_DRIVER_PLAN_CACHE_EXPERIMENT
    private func exportDirectLinkPlan(
        ...
        let manifest = DirectLinkPlanManifest(task: task, commandLine: commandLine)
